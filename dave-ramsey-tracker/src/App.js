...
const BABY_STEPS = [
  {
    ...
    description: "Build a small emergency fund to cover minor emergencies and break the cycle of debt.",
    target: 1000,
    type: "savings"
  },
  {
    ...
    description: "List debts smallest to largest, pay minimums on all, attack the smallest with intensity.",
    target: null,
    type: "debt"
  },
  {
    ...
    description: "Build a full emergency fund to protect against major life events.",
    target: null,
    type: "savings"
  },
  {
    ...
    description: "Start investing for retirement once you have your foundation in place.",
    target: 15,
    type: "investment"
  },
  {
    ...
    description: "Help your children avoid student loans by saving for their education.",
    target: null,
    type: "savings"
  },
  {
    ...
    description: "Become completely debt-free by paying off your mortgage early.",
    target: null,
    type: "debt"
  },
  {
    ...
    <div className="App">
      <header className="hero-header">
        <div className="hero-content">
          ...
          <p>Follow Dave Ramsey's proven 7 Baby Steps to achieve financial peace and build lasting wealth</p>
